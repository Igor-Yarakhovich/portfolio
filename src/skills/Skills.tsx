        ...
        <div className={style.skillsBlock} id='skillsId'>
            <div className={`${container.container} ${style.containerSkills}`}>
                ...
                <div className={style.skills}>
                    ...
                    />
                    <Skill title={"Redux"}
                           description={"JavaScript library for managing " +
                           "application state."}
                           img={redux}
                    />
                    <Skill title={"JavaScript"}
                           description={"Programming language that conforms " +
                           "to the ECMAScript specification."}
                           img={javaScript}
                    />
                    <Skill title={"TypeScript"}
                           description={"Strict syntactical superset of " +
                           "JavaScript and adds optional static typing to the language."}
                           img={typeScript}
                    />
                    <Skill title={"Rest API"}
                           description={'It is an application programming ' +
                    ...
                    />
                    <Skill title={"Axios"}
                           description={'Axios is a JavaScript library for ' +
                           'making either HTTP requests in Node. js or XMLHttpRequests ' +
                           'in the browser.'}
                           img={axios}
                    />
                    <Skill title={"GitHub"}
                           description={'The largest web service for hosting ' +
                    ...
                    <Skill title={"Story Book"}
                           ...
                           img={StoryBook}
                    />
                    <Skill title={"Unit testing & TDD"}
                           description={'This is a software testing method in ' +
                           'which individual blocks of computer software modules ' +
                           'of the source code are checked for suitability for use.'}
                           img={Testing}
                    />
                    <Skill title={"HTML"}
                           description={"HTML is a standardized document " +
                           "markup language for viewing web pages in a browser."}
                           img={HTML}
                    />
                    <Skill title={"CSS"}
                           description={"CSS is a formal language for describing " +
