            ...
            <div className={`${container.container} ${style.containerFooter}`}>
                ...
                <div className={style.social}>
                    <div className={style.icon}>
                        <a href='https://www.linkedin.com/in/игорь-ярохович-57ab671b6' target="_blank" rel="noreferrer">
                        <img src={lindeInIcon} alt=''/>
                        </a>
                    </div>
                    <div className={style.icon}>
                        <a href='https://github.com/Igor-Yarakhovich' target="_blank" rel="noreferrer">
                        <img src={gitHub} alt=''/>
                        </a>
                    </div>
                    <div className={style.icon}>
                        <a href='https://www.codewars.com/users/Igor_Yarokhovich' target="_blank" rel="noreferrer">
                            <img src={codeWars} alt=''/>
                        </a>
                    </div>
                    <div className={style.icon}>
                        <a href='https://vk.com/igoryarohovich' target="_blank" rel="noreferrer">
                            <img src={VK} alt=''/>
                        </a>
                    </div>
                </div>
